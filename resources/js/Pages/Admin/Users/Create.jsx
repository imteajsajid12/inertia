        ...
        <AdminLayout title="Create User" breadcrumbs={breadcrumbs}>
            <div className="max-w-4xl mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <Card>
                        <div className="p-6">
                            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">Password Setup</h2>
                    ...
                    <Card className="border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-900/20">
                        <div className="p-4">
                            <div className="flex items-center">
                                ...
                                <div className="ml-3">
                                    <p className="text-sm text-blue-800 dark:text-blue-200">
                                        <strong>Note:</strong> The user will receive a welcome email with their login credentials if the option is enabled.
