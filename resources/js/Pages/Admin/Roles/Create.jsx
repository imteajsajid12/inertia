...
const CreateRole = ({ permissions = [] }) => {
    ...
    const breadcrumbs = [
        ...
        { label: 'Create Role', href: null }
    ];

    return (
        <AdminLayout title="Create Role" breadcrumbs={breadcrumbs}>
            <div className="max-w-4xl mx-auto">
                <div className="mb-8">
                    <div className="flex items-center space-x-3 mb-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Create New Role</h1>
                            <p className="text-gray-600 dark:text-gray-400">Define a new role with specific permissions</p>
                        </div>
                    </div>
                </div>
